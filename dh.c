/*  This file is a MODIFIED part of the Off-the-Record Messaging library.
 *  The modifications were done by
 *
 *  Copyright (C) 2016 Kostis Andrikopoulos <mandragore@foss.ntua.gr>
 *
...
/*
 * Generate DH keypair for specified group with specified private exp
 */
...
gcry_error_t otrl_dh_keypair_compute_secret(DH_keypair *kp, gcry_mpi_t pub,
        gcry_mpi_t res)
{
    ...
    gcry_mpi_powm(res, pub, kp->priv, DH1536_MODULUS);
